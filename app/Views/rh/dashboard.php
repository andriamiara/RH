...
<div class="app-wrap">
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="metrics">
                <div class="metric"><div class="metric-top"><div class="metric-icon mi-amber"><i class="bi bi-hourglass-split"></i></div></div><div class="metric-val"><?= esc($count_attente ?? 0) ?></div><div class="metric-label">Demandes en attente</div></div>
                <div class="metric"><div class="metric-top"><div class="metric-icon mi-green"><i class="bi bi-check-circle"></i></div></div><div class="metric-val"><?= esc($count_traitees_mois ?? 0) ?></div><div class="metric-label">Traitees ce mois</div></div>
                <div class="metric"><div class="metric-top"><div class="metric-icon mi-red"><i class="bi bi-exclamation-triangle"></i></div></div><div class="metric-val"><?= esc($count_soldes_critiques ?? 0) ?></div><div class="metric-label">Soldes critiques</div></div>
            </div>
        </div>
